...
class Study(Base):
    ...
    raw_measurements: Mapped[list["RawMeasurement"]] = relationship("RawMeasurement", back_populates="study", cascade="all, delete-orphan")
    sample_collections: Mapped[list["SampleCollection"]] = relationship("SampleCollection", back_populates="study", cascade="all, delete-orphan")
...
class StudyAnimal(Base):
    ...
    reference_age: Mapped[float] = mapped_column(nullable=True)
    reference_age_unit: Mapped[str] = mapped_column(String(20), nullable=True)
    age_reference_date: Mapped[str] = mapped_column(String(30), nullable=True)
    age_reference_significance: Mapped[str] = mapped_column(String(100), nullable=True)
    brthdtc: Mapped[str] = mapped_column(String(30), nullable=True)
    age: Mapped[float] = mapped_column(nullable=True)
    age_units: Mapped[str] = mapped_column(String(20), nullable=True)
    rfxstdtc: Mapped[str] = mapped_column(String(30), nullable=True)
    rfxendtc: Mapped[str] = mapped_column(String(30), nullable=True)
