    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">SEND Submission Management Platform</p>
        </div>
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1.5">Password</label>
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-500" />
            </div>
          ...
          <div className="mt-4 p-3 rounded-lg bg-slate-800/50 text-xs text-slate-500 space-y-1">
